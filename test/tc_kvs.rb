...
class TestKVS < Test::Unit::TestCase
  ...
  def test_le
    ...
    send_channel("127.0.0.1", 10001, "kvstore", ["127.0.0.1:10001", "foo", "bar"])
    send_channel("127.0.0.1", 10001, "kvstore", ["127.0.0.1:10001", "foo", "baz"])
    send_channel("127.0.0.1", 10001, "kvstore", ["127.0.0.1:10001", "foo", "bam"])
    send_channel("127.0.0.1", 10001, "kvstore", ["127.0.0.1:10001", "foo", "bak"])
    ...
    v.bigtable.each {|b| print "OK #{b.inspect}\n"}
